...
},{"./controller":6,"jquery":1,"lodash":2}],6:[function(require,module,exports){
'use strict';
...
function addToScope(locals, identifier, instance) {
    if (locals && _.isObject(locals.$scope)) {
        ...
        throw 'Cannot export controler as ' + identifier + 
...
function $HttpProvider() {
    ...
    this.$get = ['$httpBackend', '$q', '$rootScope', '$injector',
        ...
        _.forEach(['put', 'patch', 'post'], function(method) {
...
function setupModuleLoader(window) {
    ...
    var createModule = function(name, requires, modules, configFn) {
        ...
        var invokeLater = function(service, method, arrayMethod, queue) { // an application of currying
            return function() {
...
// THE AST IS AN ARRANGEMENT OF THE ABOVE TOKENS BASED ON
...
// THE AST COMPILER TURNS THE AST INTO A FUNCTION
...
// THE PARSER STRINGS TOGETHER ALL THE ABOVE COMPONENTS
