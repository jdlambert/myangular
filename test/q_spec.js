...
describe('$q', function() {
    ...
    it('resolves a promise at next digest', function() {
        var d = $q.defer();
    ...
    it('catches rejection on a chained handler', function() {
        var d = $q.defer();
    ...
    it('fulfills on a chained handler', function() {
        var d = $q.defer();
    ...
    it('treats catch return value as a resolution', function() {
        var d = $q.defer();
        var fulfilledSpy = jasmine.createSpy();
        d.promise
            .catch(function() {
    ...
    describe('all', function() {
        ...
        it('can resolve an array of promises to an array of results', function() {
