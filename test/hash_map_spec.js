...
describe('hash', function() {
    ...
    describe('hashKey', function() {
        ...
        /* The hashKey function is not strictly a hash key function at all, in
            the same sense as the Java and Ruby methods are. In the case of object
            and data structures, it is just a unique identifier that is based on
            object identity rather than value */
        ...
        it('is not the same for different object even with the same value', function() {
            var obj1 = {a: 42};
            var obj2 = {a: 42};
            expect(hashKey(obj1)).not.toEqual(hashKey(obj2));
        });

        it('is function:[unique id] for objects', function() {
        ...
        it('is not the same for two identical functions', function() {
