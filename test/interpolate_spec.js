...
describe('$interpolate', function() {
    ...
    it('turns undefined into empty strings', function() {
        var injector = createInjector(['ng']);
        var $interpolate = injector.get('$interpolate');
    ...
    it('uses a watch delegate', function() {var injector = createInjector(['ng']); var $interpolate = injector.get('$interpolate');
