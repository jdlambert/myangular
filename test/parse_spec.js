...
describe('parse', function() {
    ...
    it('will parse a non-empty empty array', function() {
    ...
    it('looks up a 4-part identifier from the scope', function() {
    ...
    // JAVASCRIPT REPLACES undefined WITH NaN, ANGULAR REPLACES WITH 0
    ...
    it('parses relationals with a higher precedence than equality', function() {
        expect(parse('2 == "2" > 2 === "2"')()).toBe(false);
    });

    it('parses additives with a higher precedence than relationals', function() {
    ...
    it('marks non-computed lookups constant when the object is constant', function() {
        expect(parse('{a: 1}.a').constant).toBe(true);
        expect(parse('obj.a').constant).toBe(false);
    });

    it('marks computed lookups constant when the object and key are constant', function() {
        expect(parse('{a: 1}["a"]').constant).toBe(true);
        expect(parse('obj["a"]').constant).toBe(false);
