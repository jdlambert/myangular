...
describe('Scope', function() {
    ...
    describe('$digest', function() {
        ...
        it('calls listener even when watch value is first undefined', function() {
            scope.counter = 0;
        ...
        it('removes constant watches after the first invocation', function() {
    ...
    describe('a child scope', function() {
        ...
        it('can be nested at any depth', function() {
            ...
            expect(aa.anotherValue).toBeUndefined(2);
            expect(aaa.anotherValue).toBeUndefined(2);
        });
        ...
        it('can take some other scope as the parent', function() {
            ...
            var heirarchyParent = parent.$new();
    ...
    describe('$destroy', function() {
        ...
        it('prevents a scope from being digested', function() {
            var parent = createInjector(['ng']).get('$rootScope');
            var child = parent.$new();
    ...
    describe('$watchCollection', function() {
        ...
        it('notices items rearranged in an array', function() {
            scope.arr = [2, 1, 3];
            scope.counter = 0;
    ...
    describe('Events', function() {
        ...
        _.forEach(['$emit', '$broadcast'], function(method) {
            ...
            it('does not stop exceptions on ' + method, function() {
        ...
        it('propagates the same event up the scope heirarchy on $emit', function() {
            var parentListener = jasmine.createSpy();
            var scopeListener = jasmine.createSpy();
        ...
        it('propagates the same event down the scope heirarchy on $broadcast', function() {
            var scopeListener = jasmine.createSpy();
            var childListener = jasmine.createSpy();
