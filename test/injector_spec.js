...
describe('injector', function() {
    ...
    it('invokes an annotated function with dependency injectin', function() {
        var module = window.angular.module('myModule', []);
        module.constant('a', 1);
        module.constant('b', 2);
        var injector = createInjector(['myModule']);
...
describe('annotate', function() {
    ...
    it('strips comments form argument lists when parsing', function() {
        var injector = createInjector([]);
...
describe('provider', function() {
    ...
    it('injects the given provider constructor functions', function() {
        var module = window.angular.module('myModule', []);
    ...
    it('does not inject a provider into a $get function', function() {
        var module = window.angular.module('myModule', []);
    ...
    it('injects config blocks with the provider injector', function () {
        var module = window.angular.module('myModule', []);
